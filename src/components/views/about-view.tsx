        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-success/30 bg-success/5 p-5">
              <div className="text-[10px] font-mono uppercase tracking-wider text-success font-semibold mb-3">
                ✓ In Scope
              </div>
              <ul className="space-y-2 text-sm text-foreground/90">
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Smart contract escrow dengan FSM pattern
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  State transitions on-chain (Polygon Amoy)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Refund flow dengan seller approval
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  IPFS storage untuk listing metadata
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Event log transparan & auditable
                </li>
              </ul>
            </div>

            <div className="rounded-xl border border-destructive/30 bg-destructive/5 p-5">
              <div className="text-[10px] font-mono uppercase tracking-wider text-destructive font-semibold mb-3">
                ✗ Out of Scope
              </div>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-destructive mt-0.5">•</span>
                  Chat internal antar buyer & seller
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-destructive mt-0.5">•</span>
