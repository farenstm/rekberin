...
export namespace EscrowStateChangedEvent {
  export type InputTuple = [escrowId: BigNumberish, state: BigNumberish];
  export type OutputTuple = [escrowId: bigint, state: bigint];
  export interface OutputObject {
    escrowId: bigint;
    state: bigint;
  }
...
export interface EscrowChain extends BaseContract {
  ...
  filters: {
    ...
    "EscrowStateChanged(uint256,uint8)": TypedContractEvent<
      EscrowStateChangedEvent.InputTuple,
      EscrowStateChangedEvent.OutputTuple,
      EscrowStateChangedEvent.OutputObject
    >;
