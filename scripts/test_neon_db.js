...
const connectionString = "postgresql://neondb_owner:npg_PXyoG4k2Mlug@ep-crimson-term-aehai3k1-pooler.c-2.us-east-2.aws.neon.tech/neondb?sslmode=require";
...
async function testConnection() {
  ...
  try {
    ...
    const tables = await sql`
      ...
      ORDER BY table_name;
    `;
    console.log(" Tables created in Neon database:", tables.map(t => t.table_name));
